...
title(['Cluster ' num2str(iClust) ' ISI Histogram:  ' num2str(sum(H(N<threshold))) '/' num2str(sum(H)) '(' num2str(sum(H(N<threshold))/sum(H)*100) '%) ISIs less than ' num2str(threshold) 'ms']);
